...
const Features = () => {
  return (
    <div
      className={`min-h-[40vh] mb-6 p-6 md:p-8 w-[calc(100%-30px)] sm:w-[calc(100%-50px)] text-slate-300 rounded-md shadow-heroShadow 
      flex flex-col justify-start items-center gap-6 md:gap-8 bg-slate-900`}
    >
      ...
      >
        <div
          className={`min-h-[150px] w-full p-4
            ...
            rounded-md shadow-featureShadow bg-slate-800`}
        >
