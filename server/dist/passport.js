...
passport_1.default.use(new passport_google_oauth20_1.Strategy({
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let isUser = yield User_1.default.findOne({ $or: [{ googleId: user === null || user === void 0 ? void 0 : user.id }, { email: user === null || user === void 0 ? void 0 : user.email }] }).exec();
        if (!isUser) {
        ...
        isUser = yield User_1.default.findByIdAndUpdate(isUser === null || isUser === void 0 ? void 0 : isUser._id, { googleId: user === null || user === void 0 ? void 0 : user.id }, { new: true });
        const data = {
            user: {
