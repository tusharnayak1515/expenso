...
const deleteGoal = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let isGoal = yield Goal_1.default.findById(goalId).exec();
        if (!isGoal) {
        ...
        yield Goal_1.default.findByIdAndDelete(goalId, { new: true }).exec();
...
exports.default = deleteGoal;
//# sourceMappingURL=deleteGoal.js.map