            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (dp !== null && dp !== undefined) {
                    ...
                    for (const key of Object.keys(files)) {
                        ...
                        const myPath = path_1.default.join(__dirname, 'uploads', file.newFilename + extension);
                        const newPath = path_1.default.join(__dirname, 'public', 'uploads', file.newFilename + extension);
                        if ((user === null || user === void 0 ? void 0 : user.dp) !== `${APP_URL}/${newPath}`) {
